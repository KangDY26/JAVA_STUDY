...
// Ctrl + F11 : 빌드 (컴파일 + 실행)
// F2 :  에러(빨간줄)는 또는 경고(노란줄)가 있을 때 원인 및 해결책 띄우기
...
public class A00_Hello {
	...
	public static void main(String[] args) {
		...
		/*
		 	# Syste.out.println()의 ()안에 전달할 수 있는 자바 데이터의 종류(자바의 리터럴)
		 	
		 	1. "" 사이에 적는 것 : 문자열(String), 문자를 여러개 적을 수 있다
		 	2. '' 사이에 적는 것 : 문자(Characther), 문자를 하나만 적을 수 있다
		 	3. 그냥 정수를 적는 것 : 정수(Integer), 계산 가능
		 	4. 그냥 실수를 적는 것 : 실수(Float, Double), 계산 가능
		 	5. 그냥 ture 또는 false를 적는 것 : 참/거짓형 데이터
		...
		System.out.println(10 + 9);//19=10+9
		System.out.println(10 + '9'); // 67? '9'는 57번째 문자	67=10+57
		System.out.println((int)'가');// '가' 44032번째 문자
		...
		//System.out.println("오늘의 메뉴" * "순대"); 계산 안됨
		...
		// 6. 아주 큰 숫자
		System.out.println(1234567891); // 숫자를 그냥 적을 때는 대략 22억까지 사용 가능
