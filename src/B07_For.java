...
public class B07_For {
	...
	/*
	 	...
	 	- 초기값 : for문을 처음 시작하면 단 한번 실행되는 곳
	 			 주로 반복자(interator)를 초기화 하는데 사용한다
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	- 초기값에는 0을 주고 조건에는 반복하고 싶은 횟수를 적고 증가는 1씩 진행하는 방식
		 	- 원하는 횟수만큼 반복하고 싶을 떼 가장 많이 사용하는 형태
		*/
		for (int i = 0; i < 10; ++i ) {
		...
		*/
		// ex > 50에서 1까지 거꾸로 출력하고 싶은경우
		for (int i = 50; i > 0; --i) {
			System.out.println("i: " + i);
		}
		System.out.println();
		
		// ex> 2의 제곱을 출력해보고 싶은경우
