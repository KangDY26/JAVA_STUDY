...
public class C11_LocalInnerClass {
	...
	public static void main(String[] args) {
		...
		class Comicbook extends Book{
			@Override
			public void print() {
				System.out.println("부모의 기능을 덮어써서 내마음대로 바꿨습니다.");
			}
		}
		...
		// 부모 타입을 필요로하는 매개변수에 바로 상속받는 이름 없는 타입을 전달 (다형성)
		doSomething2(new Book() {
			@Override
			public void print() {
				System.out.println("Book을 상속받아서 기능을 마음대로 고쳐쎴지만 이 클래스의 이름이 무엇인지는 모릅니다");
