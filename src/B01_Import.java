...
// 내가 이 소스코드에서 A03_TypeQuiz라는 걸 쓸건데 quiz패키지에 있음
import quiz.A03_TypeQuiz;

// 내가 이 소스코드에서 Scnner라는걸 갖다 쓸건데 java.util 패키지에 있다
...
public class B01_Import {
	...
	public static void main(String[] args) {
		...
		// 다른 패키지에 속한 클래스를 부를 때는 패키지 명까지 적어야한다
		quiz.A02_SwapValue.main(null);
		
		// 패키지명을 일일이 쓰기 귀찮을때 import문을 사용한다
