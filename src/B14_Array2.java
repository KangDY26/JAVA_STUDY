...
public class B14_Array2 {
	...
	public static void main(String[]args) {
		...
		// 해당 변수명이 가리키고 있는 실체(배열) 위치를 전달하는 것이다
		// 아래 예제에서 javaClass의 실체는 하나이기 때문에
		// school[0][0]을 변경하면 school[0]과 javaClass가 함께 가리키고 있는 같은 실체를 변경하게 된다
		int[] javaClass = {30, 44, 70, 99, 80};
		int[] pythonClss = {1, 2, 3, 4, 5, 6, 7, 8};
		
		int[][] school = {javaClass, pythonClss,{30, 44, 70, 99, 80}};
		...
		// - 배열 타입 변수에는 실제 배열의 메모리상 위치(주소값)이 들어있고
