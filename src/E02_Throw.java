...
public class E02_Throw {
	/*
	 	...
	 	- RuntimeException을 상속 받는 경우 굳이 throws로 알려주지 않아도 되는 사소한 예외가 된다
	 	- Exception을 상속 받는 경우 반드시 예외처리가 되어야 컴파일이 가능한 중요한 예외가 된다
	 	  이 경우 throws로 받드시 알려주야하는 예외가 된다
	 */
	public static void method1(int a)
		...
		if (a % 2 == 1) {
			...
			throw new InputMismatchException("홀수라서 마음에 안든다");
		} else {
