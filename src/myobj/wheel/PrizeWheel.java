...
public class PrizeWheel {
	final private static boolean DEBUG_MOD = false;
	
	// boolean타입은 값이 2개라 어떤 상품에 당첨된지까지 알려주기 힘들다
	...
	/**
	 	@return -1 : 꽝 , -2 : 돌림판 당첨되었지만 수량소진, 그외 :당첨된 상품번호
	 */
