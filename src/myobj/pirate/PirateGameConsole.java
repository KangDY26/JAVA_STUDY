...
public class PirateGameConsole {
	...
	C05_PirateGame_T game = new C05_PirateGame_T();
	...
	public void start() {
		while (true) {
			...
			if(result == C05_PirateGame_T.STABBED_HOLE) {
				System.out.println("이미 찔렀던 곳은 다시 선택할 수 없습니다!!");
				continue;
			}else if (result == C05_PirateGame_T.SAFE_HOLE) {
				currPlayer.survive();
				++turn;
			}else if (result == C05_PirateGame_T.LAUNCH_HOLE) {
