...
public class D09_String {
	...
	public static void main(String[] args) {
		...
		// ""endsWish(str) : 해당 문자열이 전달한 문자열로 끝나는지 확인한다
		...
		// "".substring(start) : 해당 문자열을 원하는 위치에서 자른 인스턴스를 반환
		...
		System.out.println(anser.equals(userInput));
		System.out.println(anser.equals(userInput.trim()));
		
		// "".toUpperCase() : 해당 문자열을 모두 대문자로 변환한 새 인스턴스 반환
		// "".toLowerCase() : 해당 문자열을 모두 소문자로 변환한 새 인스턴스 반환
		String cmd = "quit";
		String userCmd = "Quit";
		...
		// 반복문을 활용하여 위의 text에서 모든 알파벳 'e'의 위치를 찾아 콘솔에 출력하시오
		
		
//		for (int i = 0; i < text.length(); ++i) {
//			if (text.charAt(i) == 'e') {
//				System.out.println(text.indexOf("e", i));
//			}
//		}
		
		// 반복문을 활용하여 위의 text에서 모든 알파벳 "ap"의 위치를 찾아 콘솔에 출력하시오
