...
public class S01_GUI {
	/*
	 	...
	 	- 자바로 GUI(Graphic User Interface) 프로그램을 만들 수 있는 APO
	...
	public static void main(String[] args) {
		...
		frame1.setLocation(1000, 100);
		// 해당 프레임의 레이아웃을 설정(레이아웃을 없앰)
		frame1.setLayout(null);
		// X 버튼을 눌렀을 때의 동작을 설정
		...
		// 창을 보이게 설정 
		// (이 시점에 화면에 그린다, 그리는 동작은 항상 모든 설정이 끝난 후에 해주는 것이 좋다)
