...
public class A01_Escape {
	...
	public static void main(String[] args) {
		...
		// 이스케이프 문자는 두 문자가 합쳐서 하나의 문자이기 때문에 ''로 사용할 수 있다
		System.out.println('\n');
		System.out.println('\t');
